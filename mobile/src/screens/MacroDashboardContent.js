...
const MacroDashboardContent = ({ navigation }) => {
            ...
            <View key={key} style={styles.macroProgressItem}>
              <View style={styles.macroProgressHeader}>
                ...
                <Text style={styles.macroProgressValue}>
                  {Math.round(macro.current)}g / {Math.round(macro.goal)}g planned
                </Text>
              </View>
              ...
              <View key={index} style={styles.trendDay}>
                ...
                {trend.status !== 'none' && (
                  <View style={styles.trendDot}>
                    <Icon name="circle" size={8} color={statusColors[trend.status] || colors.primary} />
                  </View>
                )}
              </View>
            );
...
export default MacroDashboardContent;
