...
### List Meals
- **GET** `/nutrition/meals` - List meals for current user
...
### List Foods
- **GET** `/nutrition/foods` - List all foods (public)
...
### Add Food
- **POST** `/nutrition/foods` - Add food (public)

### Get Nutrition Goals
- **GET** `/nutrition/goals` - Get nutrition goals for current user
